...
ID3D11PixelShader*  gPointLightPixelShader = nullptr;
...
bool LoadShaders()
{
    ...
    gPointLightPixelShader      = LoadPixelShader("PointLight_ps");
    gWigglePixelShader          = LoadPixelShader("Wiggle_ps");
    gFadeTexturePixelShader     = LoadPixelShader("FadeTexture_ps");
    ...
    if (gPixelLightingVertexShader  == nullptr || gPixelLightingPixelShader   == nullptr ||
        ...
        gDepthOnlyPixelShader       == nullptr || gPointLightPixelShader      == nullptr ||
        gWigglePixelShader          == nullptr || gFadeTexturePixelShader     == nullptr ||
...
void ReleaseShaders()
{
    ...
    if (gPointLightPixelShader)       gPointLightPixelShader->Release();
